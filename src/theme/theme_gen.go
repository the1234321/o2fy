...
type O2fyTheme struct{}

func (O2fyTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
...
func (O2fyTheme) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
		return fontACGNTtf
	}
	if s.Bold {
...
func (O2fyTheme) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (O2fyTheme) Size(s fyne.ThemeSizeName) float32 {
	switch s {
